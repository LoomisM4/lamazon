    ...
    <div class="row">
        ...
        <form method="post">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        <input type="text" class="form-control" value="${user.getBenutzername()}" name="benutzername">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="das Passwort wird nicht angezeigt" name="passwort">
                    </div>
                </div>
            </div>
            <div class="row">
